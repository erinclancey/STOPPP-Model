...
# write.csv(fit.posterior, "fit.posterior_preg_52_15.csv")
# fit.posterior <- read.csv("fit.posterior_preg_52.csv", header=TRUE)
# fit.posterior <- fit.posterior[,-1]
#View(fit.posterior)
# parameters are converted to weeks BDBV
omega_a=1/75
gamma=1/1.5
f=1/52
Week <- seq(0,51,1)
...
#                                    minpeakdistance = 20, npeaks = 1, nups = 0, ndowns = 0)[,2])
# }
