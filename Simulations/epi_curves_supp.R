low <- ggplot(data = data.tau.list[[1]], aes(x = t))+ theme_minimal()+ ylab("Proportion")+xlab("")+
...
low2 <- ggplot(data = data.tau.list[[1]], aes(x = t))+ theme_minimal()+ ylab("Proportion")+xlab("")+ggtitle("(a) Low Amplitude")+
  geom_line(aes(y = S/N, color="S"), alpha=1, linewidth=0.75) +
  geom_line(aes(y = I/N, color="I"), alpha=1,linewidth=0.75) +
  geom_line(aes(y = R_a/N, color="R_a"), alpha=1, linewidth=0.75)+
  geom_line(aes(y = R_i/N, color="R_i"), alpha=1, linewidth=0.75)+
...
med <- ggplot(data = data.tau.list[[101]], aes(x = t))+ theme_minimal()+ ylab("Proportion")+xlab("")+ggtitle("(b) Medium Amplitude")+
  geom_line(aes(y = S/N, color="S"), alpha=1, linewidth=0.75) +
  geom_line(aes(y = I/N, color="I"), alpha=1,linewidth=0.75) +
  geom_line(aes(y = R_a/N, color="R_a"), alpha=1, linewidth=0.75)+
  geom_line(aes(y = R_i/N, color="R_i"), alpha=1, linewidth=0.75)+
...
high <- ggplot(data = data.tau.list[[201]], aes(x = t))+ theme_minimal()+ ylab("Proportion")+xlab("")+ggtitle("(c) High Amplitude")+
  geom_line(aes(y = S/N, color="S"), alpha=1, linewidth=0.75) +
  geom_line(aes(y = I/N, color="I"), alpha=1,linewidth=0.75) +
  geom_line(aes(y = R_a/N, color="R_a"), alpha=1, linewidth=0.75)+
  geom_line(aes(y = R_i/N, color="R_i"), alpha=1, linewidth=0.75)+
