...
setwd("C:/Users/erin.clancey/Desktop/June_Revision/Longterm_example")
source("Functions and Packages_Longterm.R")

f=1/365

b_func_2 <- function(t) exp(-3.5*cos(pi*f*t-1)^2)
int=integrate(b_func_2, 0, 365)$value
pars <- expand.grid(rep=1:1,combo=2, N0=1000, beta=0.08e-02,omega_a=1/90, omega_i=1/300, gamma=1/10, mu=1/1095,
                     m=2/100, tau=1, g=1/730*365/int, s=3.5, psi=1, k=(1/730-1/1095)/1000)
