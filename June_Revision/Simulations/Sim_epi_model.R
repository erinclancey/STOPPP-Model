start_time <- Sys.time()
setwd("C:/Users/erin.clancey/Desktop/June_Revision/Simulations")
...
pars1 <- expand.grid(rep=1:100,combo=2, N0=100000, beta=0.06e-04,omega_a=1/90, omega_i=1/730, gamma=1/10, mu=1/1095,
                     m=2/365, tau=1, g=1/730*365/int, s=4, psi=2.5, k=(1/730-1/1095)/100000)

pars2 <- expand.grid(rep=1:100,combo=2, N0=100000, beta=0.06e-04,omega_a=1/90, omega_i=1/365, gamma=1/10, mu=1/730,
                     m=2/365, tau=1, g=1/365*365/int, s=4, psi=2.5,k=(1/365-1/730)/100000)

pars3 <- expand.grid(rep=1:100,combo=3, N0=100000, beta=0.06e-04,omega_a=1/365, omega_i=1/365, gamma=1/10, mu=1/730,
                     m=2/365, tau=1, g=1/365*365/int, s=4, psi=2.5,k=(1/365-1/730)/100000)
